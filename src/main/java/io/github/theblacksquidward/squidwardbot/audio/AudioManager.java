...
public class AudioManager {
    ...
    public static void init() {
        AUDIO_PLAYER_MANAGER.registerSourceManager(new SpotifySourceManager(
        ...
        AUDIO_PLAYER_MANAGER.registerSourceManager(new DeezerAudioSourceManager(Environment.getInstance().getDeezerMasterDecryptionKey()));
