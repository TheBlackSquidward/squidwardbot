...
public class DeezerAudioTrack extends DelegatedAudioTrack {
    ...
    protected final DeezerSourceManager sourceManager;

    public DeezerAudioTrack(AudioTrackInfo trackInfo, String isrc, String artworkUrl, DeezerSourceManager sourceManager) {
        super(trackInfo);
        this.isrc = isrc;
    ...
    private URI getTrackMediaURI() throws IOException, URISyntaxException {
        HttpPost getSessionID = new HttpPost(DeezerSourceManager.PRIVATE_API_BASE + "?method=deezer.ping&input=3&api_version=1.0&api_token=");
        ...
        HttpPost getUserToken = new HttpPost(DeezerSourceManager.PRIVATE_API_BASE + "?method=deezer.getUserData&input=3&api_version=1.0&api_token=");
        ...
        HttpPost getTrackToken = new HttpPost(DeezerSourceManager.PRIVATE_API_BASE + "?method=song.getData&input=3&api_version=1.0&api_token=" + apiToken);
        ...
        HttpPost getMediaURL = new HttpPost(DeezerSourceManager.MEDIA_BASE + "/get_url");
    ...
    private byte[] getTrackDecryptionKey() throws NoSuchAlgorithmException {
        ...
        var master_key = sourceManager.getMasterDecryptionKey().getBytes();
