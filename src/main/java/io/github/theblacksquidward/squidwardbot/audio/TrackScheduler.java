...
public class TrackScheduler extends AudioEventAdapter {
  ...
  private static final float[] BASS_BOOST = {
    0.15f, 0.14f, 0.13f, 0.14f, 0.05f, 0.01f, 0.02f, 0.03f, 0.04f, 0.05f, 0.06f, 0.07f, 0.08f,
    0.09f, 0.1f
  };
  ...
  private List<AudioFilter> getOrRebuildFilters(
      AudioTrack audioTrack,
      AudioDataFormat audioDataFormat,
      UniversalPcmAudioFilter downstreamAudioFilter) {
  ...
  private List<AudioFilter> buildAudioFilterChain(
      AudioTrack audioTrack,
      AudioDataFormat audioDataFormat,
      UniversalPcmAudioFilter downstreamAudioFilter) {
    ...
    if (isSlowed || isNightcore) {
      ResamplingPcmAudioFilter resamplingPcmAudioFilter =
  ...
  public void onTrackException(AudioPlayer player, AudioTrack track, FriendlyException exception) {
    LOGGER.error(
        "Exception caught that caused the audio to halt or not to start. {}",
