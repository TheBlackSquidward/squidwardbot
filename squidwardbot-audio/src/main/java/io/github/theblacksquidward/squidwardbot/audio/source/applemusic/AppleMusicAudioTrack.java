...
public class AppleMusicAudioTrack extends DelegatedAudioTrack {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AppleMusicAudioTrack.class);
    ...
    protected AudioTrack makeShallowClone() {
        return new AppleMusicAudioTrack(trackInfo, sourceManager);
    }
