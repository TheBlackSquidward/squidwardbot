...
public class TenorAPI {
    ...
    private String getSearchUrl(String query) {
        return "https://tenor.googleapis.com/v2/search?key=" + apiKey + "&limit=" + DEFAULT_LIMIT + "&media_filter=" + DEFAULT_MEDIA_FILTERS + "&q=" + URLEncoder.encode(query, StandardCharsets.UTF_8);
