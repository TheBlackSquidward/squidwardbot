...
public class CuddleCommand extends AbstractGifCommand {
  ...
  private final String[] MESSAGES = {
    "%giver% cuddles %receiver%!", "%giver% gives %receiver% a cuddle!"
  };
  ...
  public void onSlashCommand(SlashCommandInteractionEvent event) {
    ...
    MessageEmbed embed =
        getGifEmbedBuilder("anime cuddle")
  ...
  public List<OptionData> getOptionData() {
    return List.of(new OptionData(OptionType.USER, "user", "Your cuddle buddy!", true));
  }
}
