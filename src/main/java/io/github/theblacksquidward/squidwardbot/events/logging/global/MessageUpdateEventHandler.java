...
public class MessageUpdateEventHandler extends SquidwardBotEventListener {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        SquidwardBotDatabase.getInstance().getMessageCollection().insertOne(
                new MessageModel(
                        new ObjectId(),
    ...
    public void onMessageUpdate(@Nonnull MessageUpdateEvent event) {
        ...
        MessageModel message = SquidwardBotDatabase.getInstance().getMessageCollection()
        ...
        SquidwardBotDatabase.getInstance().getMessageCollection().
