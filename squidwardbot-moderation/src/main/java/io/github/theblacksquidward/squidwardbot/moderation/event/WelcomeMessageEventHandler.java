package io.github.theblacksquidward.squidwardbot.moderation.event;
...
public class WelcomeMessageEventHandler extends ListenerAdapter {
    ...
    public void onGuildMemberJoin(@NotNull GuildMemberJoinEvent event) {
        ...
        EmbedBuilder embedBuilder = new EmbedBuilder()
                ...
                .addField("Account Created: ", member.getTimeCreated().format(CUSTOM_DATE_TIME_FORMATTER), false)
