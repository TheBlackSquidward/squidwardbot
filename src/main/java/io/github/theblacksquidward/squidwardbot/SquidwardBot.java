...
public class SquidwardBot {
  ...
  public static void main(String[] args) {
    ...
    final JDABuilder jdaBuilder =
        JDABuilder.createDefault(Environment.getInstance().getDiscordBotToken());
    eventRegistry.forEachEvent(
        eventListener -> {
          jdaBuilder.addEventListeners(eventListener);
          LOGGER.info(
              "Successfully registered " + eventListener.getEventName() + " event listener.");
        });
