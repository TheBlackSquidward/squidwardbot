...
public class RainbowSixEnjoyer {
    ...
    public String getTimeSinceLastUpdate() {
        ...
        return String.format("%s %s %s", days > 0 ? String.format("%dd", days) : "",
                hours > 0 ? String.format("%dh", hours) : "",
                minutes > 0 ? String.format("%dm", minutes) : "").trim();
    }
    ...
    public String getPrettyPlaytime() {
        ...
        return String.format("%dd %dh %02dm", duration.toDaysPart(), duration.toHoursPart(), duration.toMinutesPart());
    }
    ...
    public String getKillsPerMatch() {
        return String.format("%.2f", Double.parseDouble(getKills()) / Double.parseDouble(getMatchesPlayed()));
    }
