...
public class GuildChannelUpdateEventHandler extends SquidwardBotEventListener {
  ...
  public void onChannelCreate(@Nonnull ChannelCreateEvent event) {
    ...
    TextChannel channel = guild.getTextChannelById(guildModel.channel_update_logging_channel_id());
    ...
    embedBuilder.addField(
        "Channel Type", ChannelUtils.formatChannelType(event.getChannelType()), true);
